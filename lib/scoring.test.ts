// Lipid-based EPA/AA scoring 単体テスト (v0.3.0+)
//
...
//
// 旧 v0.2.0 protein-based scoring tests (computeLight) は v0.3.0 で削除。

import { describe, it, expect, beforeEach } from "bun:test";
import { computeLipidScore, computeLipidSignal } from "./scoring";
